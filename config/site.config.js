...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'qtx@zixel.onmicrosoft.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/imzixel/qtx-pan',
    },
    {
      name: 'QTX官网',
      link: 'https://www.mcqtx.eu.org',
    },
  ],
